...
@SpringComponent
@Scope("prototype")
public class ReportTransactionMonitor extends ReportForm {
	private static final long serialVersionUID = -4877706024903750843L;
	public static final String CAPTION = "BC THỐNG KÊ GSGD-HTKH";

	public ReportTransactionMonitor() {
		super.filename = "ReportTransactionMonitor.jasper";
	}
