...
@SpringComponent
@Scope("prototype")
public class ReportTempLockCard extends ReportForm {
	private static final long serialVersionUID = -4877706024903750843L;
	public static final String CAPTION = "BC KHÓA THẺ KHẨN CẤP";

	public ReportTempLockCard() {
		super.filename = "ReportTempLockCard.jasper";
	}
